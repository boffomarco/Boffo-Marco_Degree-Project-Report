...
\title{Localisation and Mapping for an Autonomous Lawn Mower}
	\subtitle{Implementation of localisation and mapping features for an autonomous lawn mower using 
	heterogeneous sensors}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Lokalisering och kartläggning för en autonom gräsklippare}
\altsubtitle{Implementering av lokaliserings- och kartläggningsfunktioner för en autonom gräsklippare med heterogena sensorer}
